...
- [ ] **Add I²C pull-ups.** SDA and SCL have no external pull-ups. ESP32-C6 internal pulls (~45kΩ) are too weak for PCF8575 + 16 keys + rotary. Add 4.7kΩ 0603 each: `SDA → +3.3V`, `SCL → +3.3V`.
