...
| 2026-08-03 | Silkscreen wording only, no copper. The back-silk origin line went from `made in Vancouver\nCanada` to `designed in\nVancouver Canada`, and the front silk revision to `2026.8.1` since `2026.8.0` is already released. Still bottom-justified at y 105.5, so the stack above the flag is unchanged; the wider second line measures 20.286mm, 8.2mm clear of the left board edge and 8.5mm of the right. ERC 0, DRC 1 warning, parity 0 |
